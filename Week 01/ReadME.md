...
- Once the installation is done, create all the users who are a part of this email ( mehul.intern, neha.intern etc  ). Create a group called **intern** and add the users to that group .
...
# Additional Tasks
- ## A few more additions to this once the following tasks are completed:
